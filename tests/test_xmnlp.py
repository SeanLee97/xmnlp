...
def test_seg(lexical_data):
    res = [['结婚', '的', '和', '尚未', '结婚', '的', '都', '成', '了', '和尚'],
           ...
           ['<', 'h1', '>', '谷歌', '<', '/', 'h1', '>', '的', '网址', '是', 'https', ':', '/', '/', 'google', '.', 'co', 'm'],
           ['现在', '时间', '是', '2021年2', '月'],
           ['现任', '美国', '总统', '是', '拜登']]
...
def test_deep_seg_parallel(lexical_data):
    res = [['结婚', '的', '和', '尚未', '结婚', '的', '都', '成', '了', '和尚'],
           ...
           ['<', 'h1', '>', '谷歌', '<', '/', 'h1', '>', '的', '网址', '是', 'https', ':', '/', '/', 'google', '.', 'com'],
           ['现在', '时间', '是', '2021年2月'], ['现任', '美国', '总统', '是', '拜登']]
    preds = xmnlp.deep_seg_parallel(lexical_data)
    lexical_equal(preds, res)


def test_tag(lexical_data):
    res = [[('结婚', 'v'), ('的', 'u'), ('和', 'c'), ('尚未', 'd'), ('结婚', 'v'), ('的', 'u'), ('都', 'd'), ('成', 'v'), ('了', 'u'), ('和尚', 'nr')],
           [('我', 'r'), ('喜欢', 'v'), ('《', 'x'), ('瓦尔登湖', 'nr'), ('》', 'w'), ('这', 'r'), ('本书', 'r'), ('，', 'x'), ('如果', 'c'), ('你', 'r'), ('也', 'd'), ('喜欢', 'v'), ('，', 'x'), ('欢迎', 'v'), ('联系', 'n'), ('我', 'r'), ('xmlee97', 'x'), ('@', 'w'), ('gmail', 'x'), ('.', 'w'), ('com', 'x'), ('一起', 'm'), ('交流', 'n')],
           [('<', 'w'), ('h1', 'x'), ('>', 'w'), ('谷歌', 'nt'), ('<', 'w'), ('/', 'w'), ('h1', 'x'), ('>', 'w'), ('的', 'u'), ('网址', 'n'), ('是', 'v'), ('https', 'x'), (':', 'w'), ('/', 'w'), ('/', 'w'), ('google', 'x'), ('.', 'w'), ('co', 'x'), ('m', 'x')],
           [('现在', 't'), ('时间', 'n'), ('是', 'v'), ('2021年2', 't'), ('月', 'm')],
...
def test_deep_tag_parallel(lexical_data):
    res = [[('结婚', 'v'), ('的', 'u'), ('和', 'c'), ('尚未', 'd'), ('结婚', 'v'), ('的', 'u'), ('都', 'd'), ('成', 'v'), ('了', 'u'), ('和尚', 'nn')],
           ...
           [('现在', 't'), ('时间', 'n'), ('是', 'v'), ('2021年2月', 't')],
           [('现任', 'v'), ('美国', 'ns'), ('总统', 'nn'), ('是', 'v'), ('拜登', 'nr')]]
    preds = xmnlp.deep_tag_parallel(lexical_data)
    lexical_equal(preds, res)
